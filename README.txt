Example app for XCake run in January.

Simple Corkboard, iOS client and a Sinatra server. Some of the client is already done - graphics need to be updated for resolution and for terms of use/license.

Corkboard just hosts notes!

Single user 
 add a note to the corkboard
 remove a note from the corkboard (mark it as done)
